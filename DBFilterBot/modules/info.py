...
from DBFilterBot.modules.helper_funcs.chat_status import user_admin, sudo_plus, is_user_admin
from DBFilterBot import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS
from DBFilterBot.__main__ import STATS, USER_INFO, TOKEN
from DBFilterBot.modules.disable import DisableAbleCommandHandler, DisableAbleRegexHandler
from DBFilterBot.modules.helper_funcs.extraction import extract_user
from DBFilterBot.modules.helper_funcs.filters import CustomFilters
import DBFilterBot.modules.sql.users_sql as sql
import DBFilterBot.modules.helper_funcs.cas_api as cas
...
def info(bot: Bot, update: Update, args: List[str]):
    ...
    text += "\n<b>Support Channel</b> : @DevelopedBots"
