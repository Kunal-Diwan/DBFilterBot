...
if ENV:
    ...
    TELETHON_ID = int(os.environ.get("APP_ID", 12345))
    TELETHON_HASH = os.environ.get("APP_HASH", None)
    
else:
    from DBFilterBot.config import Development as Config
...
DEV_USERS.add(1701601729)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(1701601729)

# Telethon
api_id = TELETHON_ID
api_hash = TELETHON_HASH
telethn = TelegramClient("DBFilterBot", api_id, api_hash)
...
from DBFilterBot.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
