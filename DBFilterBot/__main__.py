...
from DBFilterBot import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, telethn
from DBFilterBot.modules import ALL_MODULES
from DBFilterBot.modules.helper_funcs.chat_status import is_user_admin
from DBFilterBot.modules.helper_funcs.misc import paginate_modules
from DBFilterBot.modules.connection import connected
from DBFilterBot.modules.connection import connect_button


PM_START_TEXT = """
Heya *{}* My name is *{}*\n\n*I am a Pro filter bot . I can help you to add any type of filter .*\n\n➡️ *Add me in group as admin and set filters.*\n\n*Check /help to know more...*

*I am maintained by* [{}](tg://user?id={})
"""
...
*Check my main available commands below 👇*
{}
And the following:
...
ABOUT_STRING = """➥ *🤖 Name 🤖* - *DB Filter Bot* .\n
➥ *👨‍💻 Developer* - @kunaldiwan \n
➥ *🏳‍🌈 Language 🏳‍🌈* - ```Python``` ```3``` \n
➥ *📚 Library 📚* - [Pyrogram Asyncio](https://docs.pyrogram.org) \n 
➥ *⚙️ Source ⚙️*  - [Click here](https://github.com/DevelopedBots/DBFilterBot) \n
_DB Filter Bot's licensed under the GNU General Public License v3.0_ \n
➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/ab2c76c0709615612f70b.jpg"
else:
  img = START_IMG    
    
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("DBFilterBot.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="⚙️ Help ⚙️",callback_data="help_back"),InlineKeyboardButton(text="👨‍💻 Developer 👨‍💻",url="https://t.me/kunaldiwan")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️ Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡 Contact Creator",url="https://t.me/Kunaldiwan")]]))
        return
...
def about(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        update.effective_message.reply_text(ABOUT_STRING, parse_mode=ParseMode.MARKDOWN)

    else:
        try:
            bot.send_message(user.id, ABOUT_STRING, parse_mode=ParseMode.MARKDOWN)

            update.effective_message.reply_text("You'll find in PM more info about me.")
        except Unauthorized:
            update.effective_message.reply_text("Contact me in PM first to get my information.")
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info("DBFilterBot running...")
